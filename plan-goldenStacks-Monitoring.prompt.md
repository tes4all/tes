...
### Steps
  ...
  **Observability Stack (`stacks/observability`)**
    *   **Prometheus**: Configured to scrape Swarm services via DNS discovery (`tasks.<service>`).
    *   **Grafana**: Baked dashboards for Traefik, Postgres, and Host metrics.
    *   **Alerting**: Basic Alertmanager configuration.
